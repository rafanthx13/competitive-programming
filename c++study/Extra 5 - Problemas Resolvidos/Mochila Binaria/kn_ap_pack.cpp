...
Dado uma mochila de tamanho finito e fixo e dado uma série de elemtnos com tamanho e preço
  => Como maximizar o valor da mochila

OBS: Existe a variante que é a mochila fracionária, onde se pode pegar parte dos elementos
